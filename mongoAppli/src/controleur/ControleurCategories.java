 ...
 * @author Formation
 */
public class ControleurCategories implements ActionListener, MouseListener {
    ...
    public ControleurCategories(CategorieDao catDao, CategorieVue catVue) {
        this.catDao = catDao;
        this.catVue = catVue;

    }

    public ControleurCategories(CategorieVue catVue) {
        this.catVue = catVue;
